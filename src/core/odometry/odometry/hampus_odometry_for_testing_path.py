...
#         self.create_timer(0.05, self.odometry_update)
...
#         if not self.encoder_reset:
#             self.encoder_const_left = msg.encoder_left
#             self.encoder_const_right = msg.encoder_right
#             self.encoder_reset = True
#             print(msg.encoder_left - self.encoder_const_left - self.last_accumulated_ticks_left)
       
#         # Ticks since last message
#         self.delta_accumulated_ticks_left = msg.encoder_left - self.encoder_const_left - self.last_accumulated_ticks_left
#         self.delta_accumulated_ticks_right = msg.encoder_right - self.encoder_const_right - self.last_accumulated_ticks_right
#         # print(self.delta_accumulated_ticks_left)

#         self.last_accumulated_ticks_left = msg.encoder_left - self.encoder_const_left
#         print(self.last_accumulated_ticks_left)
#         self.last_accumulated_ticks_right = msg.encoder_right - self.encoder_const_right
...
#         dist_l = 2 * math.pi * wheel_radius * self.delta_accumulated_ticks_left / ticks_per_rev
#         dist_r = 2 * math.pi * wheel_radius * self.delta_accumulated_ticks_right / ticks_per_rev
