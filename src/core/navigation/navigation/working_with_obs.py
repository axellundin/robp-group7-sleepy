...
class Explorer_node(Node):
    ...
    def turn(self):
        ...
        detection_edge = self.circle_creator.circle_filler_angle_dependent(current_x,current_y,None,self.safe_space_grid,self.max_detection_range-self.padding, True, False, False,True, None, None)
