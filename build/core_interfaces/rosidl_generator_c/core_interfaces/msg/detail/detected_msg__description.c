  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x6c, 0x61, 0x74, 0x19, 0xb7, 0xcc, 0x33, 0xc9,
      0x4d, 0xc3, 0xd6, 0x4b, 0xa7, 0xd4, 0x11, 0xde,
      0x08, 0x6a, 0x9f, 0x59, 0xb4, 0x3a, 0xf4, 0xd4,
      0x37, 0x79, 0x42, 0xae, 0x39, 0x12, 0xfe, 0x92,
    }};
  return &hash;
}
...
static char core_interfaces__msg__DetectedMsg__TYPE_NAME[] = "core_interfaces/msg/DetectedMsg";
...
static char core_interfaces__msg__DetectedMsg__FIELD_NAME__objects[] = "objects";
static char core_interfaces__msg__DetectedMsg__FIELD_NAME__boxes[] = "boxes";

static rosidl_runtime_c__type_description__Field core_interfaces__msg__DetectedMsg__FIELDS[] = {
  {
    {core_interfaces__msg__DetectedMsg__FIELD_NAME__objects, 7, 7},
    {
  ...
  {
    {core_interfaces__msg__DetectedMsg__FIELD_NAME__boxes, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription core_interfaces__msg__DetectedMsg__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {core_interfaces__msg__DetectedMsg__TYPE_NAME, 31, 31},
      {core_interfaces__msg__DetectedMsg__FIELDS, 2, 2},
    },
    {core_interfaces__msg__DetectedMsg__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "geometry_msgs/PoseStamped[] boxes";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *core_interfaces__msg__DetectedMsg__get_individual_type_description_source(NULL),
