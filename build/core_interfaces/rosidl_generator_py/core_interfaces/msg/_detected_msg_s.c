...
bool core_interfaces__msg__detected_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("core_interfaces.msg._detected_msg.DetectedMsg", full_classname_dest, 45) == 0);
  }
  core_interfaces__msg__DetectedMsg * ros_message = _ros_message;
  {  // objects
  ...
  {  // boxes
    ...
    geometry_msgs__msg__PoseStamped * dest = ros_message->boxes.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__pose_stamped__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of DetectedMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("core_interfaces.msg._detected_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DetectedMsg");
